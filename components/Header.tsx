...
export default function Header() {
  ...
  const headerClass = 'fixed top-0 left-0 right-0 z-50 bg-cream/95 backdrop-blur-md shadow-lg border-b border-secondary/20'
      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-12 h-12 rounded-xl flex items-center justify-center shadow-md transition-all bg-gradient-to-r from-secondary to-primary">
              <Coffee className="w-7 h-7 text-white" />
            </div>
            <div>
              <span className="font-script text-2xl transition-colors text-primary">Caffévo</span>
              <p className="text-xs font-semibold transition-colors text-secondary">Café & Restaurant</p>
            </div>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              className="transition-colors font-bold flex items-center gap-2 px-4 py-2 rounded-lg text-secondary hover:text-primary hover:bg-lightCream"
            >
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-lg transition-colors text-primary hover:bg-lightCream"
